function largestProductinaSeries(n) {
    ...
    for(let i = 0; i < thousandDigits.length - n + 1; i++){
        const product = thousandDigits.slice(i, i + n).reduce((t,c) => t * c);
...
/**
 * Explanation;
 * - Pretty straight-forward. You look through the list and multiply n values together at a time.
 * - If the product greater than "greatest" product, "greatest" will take on that value.
 */